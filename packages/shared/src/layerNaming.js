 ...
 */
export function suggestLayerName(ugly, mode = "game_ui") {
 ...
 */
export function isUglyName(name) {
    const ugly = [
        /^Layer \d+$/i,
        /^Untitled$/i,
        /^Group \d+$/i,
 ...
 */
export function incrementLayerName(name) {
