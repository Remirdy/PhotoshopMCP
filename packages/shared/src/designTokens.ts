...
export interface DesignTokenRadii {
  small: number;
  medium: number;
  large: number;
  capsule: number;
...
export interface DesignTokenTheme {
  name: string;
  colors: DesignTokenColors & Record<string, string>;
  radii: DesignTokenRadii;
...
export const premiumGameUI: DesignTokenTheme = {
...
export const softGame: DesignTokenTheme = {
  name: "soft_game",
  colors: {
    bgBase: "#F0EBF8",
    bgSecondary: "#E2D8F2",
...
export const iosGlass: DesignTokenTheme = {
  name: "ios_glass",
  colors: {
    bgBase: "#1C1C1E",
    bgSecondary: "#2C2C2E",
...
export const darkLuxury: DesignTokenTheme = {
  name: "dark_luxury",
  colors: {
    bgBase: "#0D0D0D",
    bgSecondary: "#1A1A1A",
...
export const cleanSaas: DesignTokenTheme = {
  name: "clean_saas",
  colors: {
    bgBase: "#FFFFFF",
    bgSecondary: "#F8FAFC",
...
export const arcadeBold: DesignTokenTheme = {
  name: "arcade_bold",
  colors: {
    bgBase: "#000033",
    bgSecondary: "#00001A",
...
export const THEMES: Record<string, DesignTokenTheme> = {
...
export function getTheme(name: string): DesignTokenTheme {
